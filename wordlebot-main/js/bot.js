...
function adjustBarHeight(points, scores, total_sum, games_played) {
    ...
    document.getElementsByClassName("average")[0].innerHTML = "Average: " + (total_sum/games_played).toFixed(4);
}
...
function runBot(guess, difficulty) {
    ...
    let iv = setInterval(function() {
        ...
        if (count >= TEST_SIZE) {
            ...
            showResults(guess, TEST_SIZE - missed.length, TEST_SIZE, average.toFixed(4), missed);
